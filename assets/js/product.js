...
function message(name,qty){return encodeURIComponent('Hello ScotiaMeds, I would like to order '+name+'. Quantity: '+qty+'. Please confirm available packs, prescription requirements and delivery options.')}
var medicineCategories={"alprazolam-alprax-2mg":[["Anxiety & Panic Disorder Medicines","anxiety-and-panic-disorders"]],"alprazolam-alprax-1mg":[["Anxiety & Panic Disorder Medicines","anxiety-and-panic-disorders"]],"alprazolam-rlam-1mg":[["Anxiety & Panic Disorder Medicines","anxiety-and-panic-disorders"]],"lorazepam-ativan-2mg":[["Anxiety & Panic Disorder Medicines","anxiety-and-panic-disorders"],["Short-term Sedation Medicines","short-term-sedation"]],"bromazepam":[["Anxiety & Panic Disorder Medicines","anxiety-and-panic-disorders"],["Short-term Sedation Medicines","short-term-sedation"]],"diazepam-martin-dow-10mg":[["Anxiety & Panic Disorder Medicines","anxiety-and-panic-disorders"],["Anxiety & Seizure Disorder Medicines","anxiety-and-seizure-disorders"],["Short-term Sedation Medicines","short-term-sedation"]],"diazepam-easium-10mg":[["Anxiety & Panic Disorder Medicines","anxiety-and-panic-disorders"]],"diazepam-sedil-5mg":[["Anxiety & Panic Disorder Medicines","anxiety-and-panic-disorders"]],"etizolam":[["Anxiety & Panic Disorder Medicines","anxiety-and-panic-disorders"]],"clonazepam-pase-2mg":[["Anxiety & Seizure Disorder Medicines","anxiety-and-seizure-disorders"]],"clonazepam-rivotril-2mg":[["Anxiety & Seizure Disorder Medicines","anxiety-and-seizure-disorders"]],"clobazam":[["Anxiety & Seizure Disorder Medicines","anxiety-and-seizure-disorders"]],"benzit":[["Anxiety & Seizure Disorder Medicines","anxiety-and-seizure-disorders"]],"nitrazepam-noctin-5mg":[["Sleep & Insomnia Medication","sleep-and-insomnia-medication"]],"zopiclone-7-5mg":[["Sleep & Insomnia Medication","sleep-and-insomnia-medication"]],"temazepam":[["Sleep & Insomnia Medication","sleep-and-insomnia-medication"]],"zolpidem":[["Sleep & Insomnia Medication","sleep-and-insomnia-medication"]],"mirtazapine-miramind":[["Sleep & Insomnia Medication","sleep-and-insomnia-medication"]],"midazolam-midolam-7-5mg":[["Short-term Sedation Medicines","short-term-sedation"]],"pregabalin-pregacare-nt":[["Nerve Pain & Neuropathy Medicines","nerve-pain-and-anxiety-related-medicines"]],"tapentadol-100mg":[["Moderate to Severe Pain Medicines","moderate-severe-pain"]],"tramadol-100mg":[["Moderate to Severe Pain Medicines","moderate-severe-pain"]],"co-codamol":[["Moderate to Severe Pain Medicines","moderate-severe-pain"]],"ritalin-alaradate-10mg":[["ADHD & Wakefulness Medicines","adhd-and-wakefulness"]],"modafinil":[["ADHD & Wakefulness Medicines","adhd-and-wakefulness"]]};
function categoryLinks(category){var items=medicineCategories[slug()];return items?items.map(function(item){return '<a href="../category/'+item[1]+'">'+safe(item[0])+'</a>'}).join('<br>'):safe(category)}
function spec(brand,manufacturer,vendor,category){return '<dl class="spec-list"><div><dt>Brand name</dt><dd>'+safe(brand)+'</dd></div><div><dt>Manufacturer</dt><dd>'+safe(manufacturer)+'</dd></div><div><dt>Vendor</dt><dd>'+safe(vendor)+'</dd></div><div><dt>Category</dt><dd>'+categoryLinks(category)+'</dd></div><div><dt>Prescription</dt><dd>Required</dd></div></dl>'}
...
function init(){
 ...
 var description=article.innerHTML,details=spec(brand,manufacturer,vendor,category),productImage=productImages[pageSlug]||'medicine-product.svg';
 ...
 html=html.replace(root+'/assets/img/medicine-product.svg',root+'/assets/img/'+(productImages[pageSlug]?'medicine/':'')+productImage).replace('<img src="'+root+'/assets/img/'+(productImages[pageSlug]?'medicine/':'')+productImage+'"','<img decoding="async" src="'+root+'/assets/img/'+(productImages[pageSlug]?'medicine/':'')+productImage+'"');
