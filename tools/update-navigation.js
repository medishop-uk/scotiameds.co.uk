...
function updatePagesJs() {
  ...
  const replacement=`function header(){const active=x=>(kind.startsWith(x)||(kind==='product'&&x==='shop'))?' class="active"':'';return \`<a class="page-skip" href="#page-content">Skip to content</a><div class="page-notice"><div class="page-container"><p>Private UK-wide delivery</p><p>Prescription medicines require a valid prescription · <a href="\${root}/#how-it-works">How requests work</a></p></div></div><header class="page-header"><div class="page-container page-header-inner"><a class="page-brand" href="\${root}/"><img src="\${root}/assets/img/logo.svg" alt="ScotiaMeds"></a><nav class="page-nav">${dropdown('${root}/')}<a href="\${root}/">Home</a><a\${active('shop')} href="\${root}/shop/">Shop</a><a\${active('blog')} href="\${root}/blog/">Blog</a><a\${active('about')} href="\${root}/about-us/">About Us</a><a\${active('contact')} href="\${root}/contact-us/">Contact Us</a></nav><div class="page-actions"><a class="nav-contact nav-whatsapp" href="https://wa.me/447438135064" target="_blank" rel="noopener">WhatsApp</a><a class="nav-contact nav-telegram" href="https://t.me/BenzoAddy" target="_blank" rel="noopener">Telegram</a><button class="page-menu" aria-label="Open menu" aria-expanded="false"><i></i><i></i><i></i></button></div></div><nav class="page-mobile-nav">${dropdown('${root}/')}<a href="\${root}/">Home</a><a href="\${root}/shop/">Shop</a><a href="\${root}/blog/">Blog</a><a href="\${root}/about-us/">About Us</a><a href="\${root}/contact-us/">Contact Us</a></nav></header>\`}`;
...
function updateHomepage() {
  ...
  html=html.replace(/<div class='header-actions'>[\s\S]*?<button class='menu-button'/,`<div class='header-actions'><a class='nav-contact nav-whatsapp' href='https://wa.me/447438135064' target='_blank' rel='noopener'>WhatsApp</a><a class='nav-contact nav-telegram' href='https://t.me/BenzoAddy' target='_blank' rel='noopener'>Telegram</a><button class='basket-button' data-cart-open>Basket <b data-cart-count>0</b></button><button class='menu-button'`);
